...
Scene.start = function () {
	...
	// Seup the frames to be displayed.
	...
	Scene.bimage = new Image(2878,1031);
    Scene.bimage.src = 'background.png';


	
	// Wait till the sprites is loaded before starting the animation.
...
Scene.update = function () {
	// Set the canvas width to be that of the display Window. Which helps if you resize the window.
  	Scene.canvas.width = 2000;
  	Scene.canvas.height = 2000;
...
Scene.draw = function () {
	Scene.canvasContext.drawImage(Scene.bimage, 0, 0, 2878, 1031, 0, 0, 2878, 700);
	Scene.canvasContext.drawImage(Scene.sprite.img,Scene.sprite.frames[Scene.sprite.frame].frame.x,
		...
		Scene.sprite.offset,0,Scene.sprite.frames[Scene.sprite.frame].frame.w,
		Scene.sprite.frames[Scene.sprite.frame].frame.h);
